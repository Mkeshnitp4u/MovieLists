...
const Icon = (props) => {
  ...
  const color = colorProp || DefaultTheme.colors.black;
  const reverseColor = reverseColorProp || DefaultTheme.colors.white;
  ...
  const getBackgroundColor = () => {
    ...
    return raised ? DefaultTheme.colors.white : 'transparent';
  };
